                      ...
                      if administrator == message.from_user.id:  
                          ...
                          try:
                              ...
                              await lel.edit(
                                  ...
                                  "\n\nOr manually add @sathish20040 to your Group and try again</b>",
                              )
                              pass
    try:
        chatdetails = await USER.get_chat(chid)
...
async def jiosaavn(client: Client, message_: Message):
    ...
    keyboard = InlineKeyboardMarkup(
         [   
             ...
             [
               InlineKeyboardButton(
                   text="Join Updates Groups",
                   url='https://t.me/musicgroup24x7x365')
             ],
             [       
               InlineKeyboardButton(
                   text="❌ Close",
    ...
    if message_.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        m = await client.send_photo(
            ...
            reply_markup=keyboard,
            photo="final.png",
            caption=f"✯MUSIC GROUP✯=#️⃣ Queued at position {position}",
        
        )           
           
    else:
        await res.edit_text("✯MUSIC GROUP✯=▶️ Playing.....")
        chat_id = message_.chat.id
        que[chat_id] = []
        qeue = que.get(message_.chat.id)
        s_name = sname
